...
class ArticleAdapter(private val mContext: Context, private val listArticle: List<Article>) :
    ArrayAdapter<Article>(mContext, 0, listArticle) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val linearviewArticle = view.findViewById<LinearLayout>(R.id.Article)
        val movement = view.findViewById<ImageView>(R.id.Storie)
        ...
        if (stock.text.toString().toInt() <= 0) {
            ...
            linearviewArticle!!.setBackgroundColor(Color.parseColor(noHaveStock))
        }
        ...
        moreStock.setOnClickListener {
            /*
            val dialogView = viewInflater.from(context).inflate(R.view.modify_stock_alert, null)
